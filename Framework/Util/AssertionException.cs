...
namespace Test.Framework.Util {
	...
	internal sealed class AssertionException : Exception {
		/// <summary>
		/// Initializes a new instance of the <see cref="Test.Framework.Util.AssertionException" /> class with a specified error message.
		/// </summary>
		/// <param name="message">The message that describes the error.</param>
		public AssertionException(string message) : base(message) { }
		/// <summary>
		/// Initializes a new instance of the <see cref="Test.Framework.Util.AssertionException" /> class with a specified formatted error message.
		/// </summary>
