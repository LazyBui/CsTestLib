...
namespace TestLib.Framework.Util {
	...
	/// If both outputs are required, please use <see cref="TestLib.Framework.Util.ProcessSpawnerWithCombinedAndSplitErrAndOut" />.
	/// </summary>
	public sealed class ProcessSpawnerWithCombinedErrAndOut : IProcessSpawner {
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TestLib.Framework.Util.ProcessSpawnerWithCombinedErrAndOut" /> class with a specified file.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TestLib.Framework.Util.ProcessSpawnerWithCombinedErrAndOut" /> class with a specified file and command line arguments.
		/// </summary>
		/// <param name="file">The name of the file to execute.</param>
		...
		/// </summary>
		/// <returns>A <see cref="TestLib.Framework.Util.ProcessResult" /> object representing the execution.</returns>
		...
		/// <summary>
		/// Releases all resources used by the current instance of the <see cref="TestLib.Framework.Util.ProcessSpawnerWithCombinedErrAndOut" /> class.
		/// </summary>
		public void Dispose() {
			Dispose(true);
