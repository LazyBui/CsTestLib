...
namespace TestLib.Framework.Util {
	...
	internal sealed class EqualityComparerStateful<TValue> : IEqualityComparer<TValue> {
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TestLib.Framework.Util.EqualityComparerStateful&lt;TValue&gt;" /> class with a specified comparer delegate and optional hasher delegate.
