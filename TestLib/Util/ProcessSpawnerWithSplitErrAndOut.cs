...
namespace TestLib.Framework.Util {
	...
	/// </summary>
	public sealed class ProcessSpawnerWithSplitErrAndOut : IProcessSpawner {
		...
		/// <summary>z
		/// Initializes a new instance of the <see cref="TestLib.Framework.Util.ProcessSpawnerWithSplitErrAndOut" /> class with a specified file.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TestLib.Framework.Util.ProcessSpawnerWithSplitErrAndOut" /> class with a specified file and command line arguments.
		/// </summary>
		/// <param name="file">The name of the file to execute.</param>
		...
		/// <summary>
		/// Releases all resources used by the current instance of the <see cref="TestLib.Framework.Util.ProcessSpawnerWithSplitErrAndOut" /> class.
		/// </summary>
		public void Dispose() {
			Dispose(true);
