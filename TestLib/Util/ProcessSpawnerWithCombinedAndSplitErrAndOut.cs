...
namespace TestLib.Framework.Util {
	...
	/// If you do not need both outputs, it is recommended to use <see cref="TestLib.Framework.Util.ProcessSpawnerWithCombinedErrAndOut" /> or <see cref="TestLib.Framework.Util.ProcessSpawnerWithSplitErrAndOut" />.
	/// </summary>
	public sealed class ProcessSpawnerWithCombinedAndSplitErrAndOut : IProcessSpawner {
		...
		/// <summary>
		/// Releases all resources used by the current instance of the <see cref="TestLib.Framework.Util.ProcessSpawnerWithCombinedAndSplitErrAndOut" /> class.
		/// </summary>
		public void Dispose() {
			Dispose(true);
